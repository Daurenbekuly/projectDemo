package net.alibi.projectDemo;

import net.alibi.projectDemo.listener.FileMessageListener;
...
public class ProjectDemoApplication {
	...
	@Bean
	MessageListenerAdapter listenerAdapter(FileMessageListener receiver) {
